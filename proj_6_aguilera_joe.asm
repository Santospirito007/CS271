TITLE Programming Assignment #6A    (proj_6_aguilera_joe.asm)

; Author:	Joe Aguilera
; Course / Project ID: Project 6 CS271 Winter 2016	Date: 3/08/2016
; Description:
...
welcome					BYTE	  "Welcome to Low Level I/O by Joe Aguilera.", 0
...
errString					BYTE	  "Invalid entry, please try again: ", 0
spaces					BYTE	  ", ", 0
goodbye					BYTE	  "Good-Bye, come again soon!", 0
	...
	userNumberLoop: 	
					...
					mov		ebx, 00000000			; we will use ebx as ACCUMULATOR
						...
						str2int:
							...
							jl		errMessage		; error checking
							cmp		eax, HI			; error checking
							jg		errMessage		; error checking
