TITLE Programming Assignment #4 Accumulator    (Proj_4_aguilera_joe.asm)

; Author:	Joe Aguilera
; Course / Project ID: Project 4  CS271 Winter 2016	Date: 2/16/2016
; Description:
...
welcome				BYTE	  "Welcome to Composites by Joe Aguilera.", 0
